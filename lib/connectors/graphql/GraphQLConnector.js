...
import { HTTPRequest, HTTPResponse, ConnectorError } from '../../connectors/Connector';
...
var GraphQLConnector = /** @class */ (function (_super) {
    ...
    GraphQLConnector.prototype.send = function (req) {
        return __awaiter(this, void 0, void 0, function () {
            var res, authorization_1, errors;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (res.data.errors) {
                            ...
                            errors = res.data.errors.map(function (e) {
                        ...
                        return [2 /*return*/, new HTTPResponse(res.data)];
                }
            });
        });
    };
    GraphQLConnector.prototype.transformRequest = function (request) {
        var fetchFieldName = inflection.camelize(inflection.pluralize(name), true);
