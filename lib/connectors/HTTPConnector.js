...
var HTTPConnector = /** @class */ (function () {
    ...
    HTTPConnector.prototype.sendHttpRequest = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var defaultHeaders, headers, res, data, contentType, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        headers = __assign(__assign({}, defaultHeaders), resolveOptionalThunk(this.config.headers));
                    ...
                    case 1:
                        ...
                        _a = contentType && contentType.split(";")[0];
                        switch (_a) {
                            case "application/json": return [3 /*break*/, 2];
                        }
                        return [3 /*break*/, 4];
                    ...
                    case 5:
                        data = _b.sent();
                        _b.label = 6;
                    case 6: return [2 /*return*/, new HTTPResponse(data, res.status)];
                }
            });
        });
    };
