...
import { resolveOptionalThunkAsync } from "ts-thunk";
...
var HTTPConnector = /** @class */ (function () {
    ...
    HTTPConnector.prototype.sendHttpRequest = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var defaultHeaders, headers, _a, res, data, contentType, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _a = [__assign({}, defaultHeaders)];
                        return [4 /*yield*/, resolveOptionalThunkAsync(this.config.headers)];
                    case 1:
                    ...
                    case 2:
                        res = _c.sent();
                        data = null;
                        if (!(res.status !== 204)) return [3 /*break*/, 7];
                        contentType = res.headers.get("content-type");
                        _b = contentType && contentType.split(";")[0];
                        switch (_b) {
                    ...
                    case 6:
                        data = _c.sent();
                        _c.label = 7;
                    case 7: return [2 /*return*/, new HTTPResponse(data, res.status)];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, this.transformResponse(res, request)];
                }
            });
        });
    };
