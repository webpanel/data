...
var ResourceCollection = /** @class */ (function (_super) {
    ...
    function ResourceCollection(config) {
        ...
        _this.get = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.loading = true;
                        return [4 /*yield*/, this.dataSource.list(this.name, this.fields, this.filters, this.sorting, this.offset, this.limit, this.arguments)];
                    case 1:
                        res = _a.sent();
                        if (res) {
                            this.data = res.items || [];
        ...
        _this.delete = function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dataSource.delete(this.name, id, [])];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res];
                }
        ...
        _this.sorting = config.sorting;
        _this.offset = config.offset;
        _this.limit = config.limit;
        return _this;
    }
    ResourceCollection.prototype.updateFilters = function (filters) {
        this.filters = filters;
        return this.get();
    };
    ResourceCollection.prototype.updateSorting = function (sorting) {
        this.sorting = sorting;
        return this.get();
    };
    ResourceCollection.prototype.updateOffset = function (offset) {
        this.offset = offset;
        return this.get();
    };
    ResourceCollection.prototype.updateLimit = function (limit) {
        this.limit = limit;
        return this.get();
    };
    __decorate([
