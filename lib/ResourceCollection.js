...
var ResourceCollection = /** @class */ (function (_super) {
    ...
    function ResourceCollection(config) {
        ...
        _this.delete = function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dataSource.delete(this.name, id, this.fields)];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res];
                }
        ...
        _this.updateFilters(config.initialFilters, false);
        return _this;
    }
    ResourceCollection.prototype.updateFilters = function (filters, autoreload) {
        if (autoreload === void 0) { autoreload = true; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.updateNamedFilters('_default', filters, autoreload)];
            });
        });
    };
    ResourceCollection.prototype.updateNamedFilters = function (key, filters, autoreload) {
        if (autoreload === void 0) { autoreload = true; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
