...
var GraphQLConnector = /** @class */ (function () {
    function GraphQLConnector() {
    }
    GraphQLConnector.prototype.send = function (url, query) {
        return __awaiter(this, void 0, void 0, function () {
            var body, accessToken, res, json, authorization_1, errors;
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (json.errors) {
                            ...
                            errors = json.errors.map(function (e) {
                        ...
                        return [2 /*return*/, new GraphQLResponse(json.data)];
                }
            });
        });
    };
