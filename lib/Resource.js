            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.tryWithLoading(this.dataSource.create(this.name, values, fields, this.arguments))];
                    case 1:
                        res = _a.sent();
                        this.data = res;
                        this.id = res.id;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.tryWithLoading(this.dataSource.update(this.name, this.id, props.values, props.fields || this.fields, this.arguments))];
                    case 1:
                        res = _a.sent();
