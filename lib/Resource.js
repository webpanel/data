...
var Resource = /** @class */ (function (_super) {
    ...
    function Resource(config) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.tryWithLoading(this.dataSource.read(this.name, this.id, this.fields))];
                    case 1:
                        res = _a.sent();
                        this.data = res;
                        return [2 /*return*/, res];
        ...
        _this.create = function (values) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.tryWithLoading(this.dataSource.create(this.name, values, ['id'].concat(this.fields)))];
                    case 1:
                        res = _a.sent();
                        this.data = res;
                        this.id = res.id;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.tryWithLoading(this.dataSource.update(this.name, this.id, values, this.fields))];
                    case 1:
                        res = _a.sent();
                        this.data = res;
                        return [2 /*return*/, res];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.tryWithLoading(this.dataSource.delete(this.name, this.id, this.fields))];
                    case 1:
                        res = _a.sent();
                        this.data = res;
                        return [2 /*return*/, res];
        ...
        _this.id = config.id;
        if (!_this.id) {
            _this.data = config.defaultValues;
        }
        return _this;
    }
