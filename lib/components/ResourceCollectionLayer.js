...
var ResourceCollectionLayer = /** @class */ (function (_super) {
    ...
    ResourceCollectionLayer.prototype.componentDidMount = function () {
        this.createResource();
        if (this.state.resource) {
            this.state.resource.startPolling();
        }
    };
    ResourceCollectionLayer.prototype.componentWillUnmount = function () {
        if (this.state.resource) {
            this.state.resource.stopPolling();
        }
    };
    ResourceCollectionLayer.prototype.componentDidUpdate = function () {
        if (!this.props.values) {
            return;
        }
        var _a = this.props.values, filters = _a.filters, search = _a.search, sorting = _a.sorting, offset = _a.offset, limit = _a.limit;
        ...
        var hasChange = false;
        if (JSON.stringify(_resource.namedFilter('$_layer')) !==
    ...
    ResourceCollectionLayer.prototype.reload = function () {
        var resource = this.state.resource;
        if (!resource) {
            return;
        }
